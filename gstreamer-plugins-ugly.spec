# $Id: gstreamer-plugins-ugly.spec,v 1.1 2008/07/24 09:49:57 jwrdegoede Exp $
# Authority: matthias
...
Patch0: gstreamer-plugins-ugly-mpegaudioparse.patch
Patch1: gst-plugins-ugly-0.10.6-asf-seek.patch
Patch2: gst-plugins-ugly-0.10.6-dvdread.patch
...
%changelog
* Wed Jul 23 2008 Hans de Goede <j.w.r.degoede@hhs.nl> 0.10.6-6
